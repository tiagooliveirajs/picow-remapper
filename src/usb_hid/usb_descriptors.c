...
{
    if (instance == REMAPPER_USB_HID_MOUSE_INTERFACE) return k_mouse_report_descriptor;
    if (instance == REMAPPER_USB_HID_KEYBOARD_INTERFACE) return k_keyboard_report_descriptor;
    return NULL;
}
